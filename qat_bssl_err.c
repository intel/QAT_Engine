...
static ERR_STRING_DATA QAT_str_functs[] = {
    ...
    {ERR_PACK(0, QAT_F_MB_ECDSA_DO_VERIFY, 0), "mb_ecdsa_do_verify"},
    ...
    {ERR_PACK(0, QAT_F_MB_ECDSA_VERIFY, 0), "mb_ecdsa_verify"},
    {ERR_PACK(0, QAT_F_MB_SM2_CTRL, 0), "mb_sm2_ctrl"},
    {ERR_PACK(0, QAT_F_MB_SM2_INIT, 0), "mb_sm2_init"},
    ...
    {ERR_PACK(0, QAT_F_QAT_AES_CCM_CIPHER, 0), "qat_aes_ccm_cipher"},
    {ERR_PACK(0, QAT_F_QAT_AES_CCM_CLEANUP, 0), "qat_aes_ccm_cleanup"},
    {ERR_PACK(0, QAT_F_QAT_AES_CCM_CTRL, 0), "qat_aes_ccm_ctrl"},
    {ERR_PACK(0, QAT_F_QAT_AES_CCM_INIT, 0), "qat_aes_ccm_init"},
    {ERR_PACK(0, QAT_F_QAT_AES_CCM_SESSION_INIT, 0),
     "qat_aes_ccm_session_init"},
    {ERR_PACK(0, QAT_F_QAT_AES_CCM_TLS_CIPHER, 0), "qat_aes_ccm_tls_cipher"},
    ...
    {ERR_PACK(0, QAT_F_QAT_CREATE_SM4_CBC_CIPHER_METH, 0),
     "qat_create_sm4_cbc_cipher_meth"},
    {ERR_PACK(0, QAT_F_QAT_CREATE_SM4_CCM_CIPHER_METH, 0),
     "qat_create_sm4_ccm_cipher_meth"},
    ...
    {ERR_PACK(0, QAT_F_QAT_HKDF_CTRL, 0), "qat_hkdf_ctrl"},
    ...
    {ERR_PACK(0, QAT_F_QAT_REMAP_INSTANCES, 0), "qat_remap_instances"},
    ...
    {ERR_PACK(0, QAT_F_QAT_SETUP_OP_PARAMS, 0), "qat_setup_op_params"},
    ...
    {ERR_PACK(0, QAT_F_QAT_SM2_COMPUTE_Z_DIGEST, 0),
     "qat_sm2_compute_z_digest"},
    {ERR_PACK(0, QAT_F_QAT_SM2_COPY, 0), "qat_sm2_copy"},
    {ERR_PACK(0, QAT_F_QAT_SM2_CTRL, 0), "qat_sm2_ctrl"},
    {ERR_PACK(0, QAT_F_QAT_SM2_DIGEST_CUSTOM, 0), "qat_sm2_digest_custom"},
    {ERR_PACK(0, QAT_F_QAT_SM2_INIT, 0), "qat_sm2_init"},
    {ERR_PACK(0, QAT_F_QAT_SM2_SIGN, 0), "qat_sm2_sign"},
    {ERR_PACK(0, QAT_F_QAT_SM2_VERIFY, 0), "qat_sm2_verify"},
    {ERR_PACK(0, QAT_F_QAT_SM4_CBC_CLEANUP, 0), "qat_sm4_cbc_cleanup"},
    {ERR_PACK(0, QAT_F_QAT_SM4_CBC_DO_CIPHER, 0), "qat_sm4_cbc_do_cipher"},
    {ERR_PACK(0, QAT_F_QAT_SM4_CBC_INIT, 0), "qat_sm4_cbc_init"},
    {ERR_PACK(0, QAT_F_QAT_SW_INIT, 0), "qat_sw_init"},
    {ERR_PACK(0, QAT_F_QAT_SW_SM3_FINAL, 0), "qat_sw_sm3_final"},
    {ERR_PACK(0, QAT_F_QAT_SW_SM3_INIT, 0), "qat_sw_sm3_init"},
    {ERR_PACK(0, QAT_F_QAT_SW_SM3_UPDATE, 0), "qat_sw_sm3_update"},
    {ERR_PACK(0, QAT_F_QAT_SW_SM4_CBC_CIPHER, 0), "qat_sw_sm4_cbc_cipher"},
    {ERR_PACK(0, QAT_F_QAT_SW_SM4_CBC_CLEANUP, 0), "qat_sw_sm4_cbc_cleanup"},
    {ERR_PACK(0, QAT_F_QAT_SW_SM4_CBC_KEY_INIT, 0), "qat_sw_sm4_cbc_key_init"},
    {ERR_PACK(0, QAT_F_QAT_SW_SM4_CCM_CLEANUP, 0), "qat_sw_sm4_ccm_cleanup"},
    {ERR_PACK(0, QAT_F_QAT_SW_SM4_CCM_CTRL, 0), "qat_sw_sm4_ccm_ctrl"},
    {ERR_PACK(0, QAT_F_QAT_SW_SM4_CCM_DECRYPT, 0), "qat_sw_sm4_ccm_decrypt"},
    {ERR_PACK(0, QAT_F_QAT_SW_SM4_CCM_DO_CIPHER, 0),
     "qat_sw_sm4_ccm_do_cipher"},
    {ERR_PACK(0, QAT_F_QAT_SW_SM4_CCM_ENCRYPT, 0), "qat_sw_sm4_ccm_encrypt"},
    {ERR_PACK(0, QAT_F_QAT_SW_SM4_CCM_INIT, 0), "qat_sw_sm4_ccm_init"},
    {ERR_PACK(0, QAT_F_QAT_SW_SM4_GCM_CIPHER, 0), "qat_sw_sm4_gcm_cipher"},
    {ERR_PACK(0, QAT_F_QAT_SW_SM4_GCM_CLEANUP, 0), "qat_sw_sm4_gcm_cleanup"},
    {ERR_PACK(0, QAT_F_QAT_SW_SM4_GCM_CTRL, 0), "qat_sw_sm4_gcm_ctrl"},
    {ERR_PACK(0, QAT_F_QAT_SW_SM4_GCM_DECRYPT, 0), "qat_sw_sm4_gcm_decrypt"},
    {ERR_PACK(0, QAT_F_QAT_SW_SM4_GCM_ENCRYPT, 0), "qat_sw_sm4_gcm_encrypt"},
    {ERR_PACK(0, QAT_F_QAT_SW_SM4_GCM_INIT, 0), "qat_sw_sm4_gcm_init"},
    {ERR_PACK(0, QAT_F_QAT_SW_SM4_GCM_TLS_CIPHER, 0),
     "qat_sw_sm4_gcm_tls_cipher"},
    ...
    {ERR_PACK(0, QAT_F_SM2_COMPUTE_MSG_HASH, 0), "sm2_compute_msg_hash"},
...
static ERR_STRING_DATA QAT_str_reasons[] = {
    ...
    {ERR_PACK(0, 0, QAT_R_BAD_LENGTH), "bad length"},
    {ERR_PACK(0, 0, QAT_R_BAD_TLS_CLIENT_VERSION), "bad tls client version"},
    ...
    {ERR_PACK(0, 0, QAT_R_CURVE_NOT_SUPPORTED), "curve not supported"},
    ...
    {ERR_PACK(0, 0, QAT_R_DATA_TOO_LARGE_FOR_KEY_SIZE),
    ...
    {ERR_PACK(0, 0, QAT_R_FAILED_TO_DECRYPT), "failed to decrypt"},
    ...
    {ERR_PACK(0, 0, QAT_R_INVALID_KEY), "invalid key"},
    ...
    {ERR_PACK(0, 0, QAT_R_INVALID_LENGTH), "invalid length"},
    ...
    {ERR_PACK(0, 0, QAT_R_KEY_SIZE_TOO_SMALL), "key size too small"},
    ...
    {ERR_PACK(0, 0, QAT_R_OPERATION_NOT_SUPPORTED_FOR_THIS_KEYTYPE),
    ...
    {ERR_PACK(0, 0, QAT_R_PKCS_DECODING_ERROR), "pkcs decoding error"},
    {ERR_PACK(0, 0, QAT_R_POLLING_THREAD_COND_INIT_FAILURE),
     "polling thread cond init failure"},
    ...
    {ERR_PACK(0, 0, QAT_R_PROV_EC_SEC_NULL), "prov ec sec null"},
    {ERR_PACK(0, 0, QAT_R_PROV_FINAL_CALL_OUT_OF_ORDER),
     "prov final call out of order"},
    {ERR_PACK(0, 0, QAT_R_PROV_INVALID_CTX_LIB), "prov invalid ctx lib"},
    {ERR_PACK(0, 0, QAT_R_PROV_KEY_SIZE_TOO_SMALL), "prov key size too small"},
    {ERR_PACK(0, 0, QAT_R_PROV_ONESHOT_CALL_OUT_OF_ORDER),
     "prov oneshot call out of order"},
    {ERR_PACK(0, 0, QAT_R_PROV_UPDATE_CALL_OUT_OF_ORDER),
     "prov update call out of order"},
    ...
    {ERR_PACK(0, 0, QAT_R_UNSUPPORTED_RSA_KEY_SIZE),
