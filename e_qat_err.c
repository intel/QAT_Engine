...
static ERR_STRING_DATA QAT_str_functs[] = {
    ...
    {ERR_PACK(0, QAT_F_MULTIBUFF_ENGINE_CTRL, 0), "multibuff_engine_ctrl"},
    {ERR_PACK(0, QAT_F_MULTIBUFF_ENGINE_FINISH_INT, 0),
     "multibuff_engine_finish_int"},
    {ERR_PACK(0, QAT_F_MULTIBUFF_ENGINE_INIT, 0), "multibuff_engine_init"},
