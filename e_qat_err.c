...
static ERR_STRING_DATA QAT_str_reasons[] = {
    ...
    {ERR_PACK(0, 0, QAT_R_ENGINE_HW_NOT_SUPPORTED), "engine hw not supported"},
    ...
    {ERR_PACK(0, 0, QAT_R_ENGINE_SET_GCM_CIPHERS_FAILURE),
    "engine set gcm ciphers failure"},
    ...
    {ERR_PACK(0, 0, QAT_R_ENGINE_SET_X25519_FAILURE),
    "engine set x25519 failure"},
